...
Focus more on the ML logic aspect of it, rather than the engg work of indexing, for example - if you chose to pick a Vector DB, pick the easiest and most convenient one instead of spending time and code on rewriting your own version. You are assessed first and foremost on ML logic.
...
Approaches: Possible ways to solve this problem, tradeoffs, what’s good and when
Short Write-up on Chosen Approach: A brief explanation of your chosen architecture & how it handles fashion queries
Codebase (GitHub) Link: Clean, documented code for both the indexing and retrieval pipelines.
Approaches for future work
How to extend this solution for adding locations (cities, places) and weather
How to improve precision

6. What We Are Looking For
Thoughtful solution: 
Getting a solution in the age of AI is easy - coding it successfully, understanding the chosen approach (model, arch), what are its shortcomings & how to address that are sought
How well does it work for fashion based queries?
Modular Code: Is your logic separated from your data?
Scalability: Would your retrieval logic work if the dataset grew to 1 million images?
Zero-Shot Capability: How well does the system handle descriptions it hasn't seen explicitly in a training label?
